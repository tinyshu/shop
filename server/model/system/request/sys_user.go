...
type ChangeUserInfo struct {
	...
	AuditStatus        int8      `json:"auditStatus" gorm:"column:audit_status;default:1;comment:审核状态 见 system.AuditStatus* 常量"` // 审核状态：AuditStatusNew/Passed/Pending/Changing/Rejected
